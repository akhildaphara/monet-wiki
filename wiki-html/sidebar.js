document.addEventListener("DOMContentLoaded", () => {
    ...
    const links = [
        ...
        {
            href: "Apple-Developer-Org-Registration.html",
            label: "Apple Org Registration",
        ...
        {
            href: "TestFlight-Compliance-Checklist.html",
            label: "TestFlight Checklist",
