...
- **Action**: When the Insights dashboard returns, don't just show what the user earned. Show what they *could have* earned. Display a metric: "You lost $14.50 this month by using the wrong card at CVS." Loss aversion is a powerful motivator, and it proves the value of the app instantly.
